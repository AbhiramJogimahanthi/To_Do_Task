  ...
  for (let i = 0; i < tasks.length; i++) {
    ...
    if (title == title_c) {
      if(completed == 1) {
        ...
        <button class="btn btn_check" onclick="check_task('`+title+`')"><i class="fas fa-check-circle"></i></button>
        <button class="btn btn_delete" onclick="delete_task('`+title+`')"><i class="fas fa-trash"></i></button>
        <button class="btn btn_display" onclick="displayTask()"><i class="fas fa-info-circle"></i></button>
        <div class="todo_task_description">
            <p class="task_description">
            `+description+`
            </p>
            <article class="task_deadline"> [ `+deadline+` ] </article>
        </div>
        </div>
        `;
      }
      ...
      if(tasks[i].completed == 0){
        display.innerHTML += `
          ...
          <button class="btn btn_check" onclick="check_task('`+title+`')"><i class="fas fa-check-circle"></i></button>
          <button class="btn btn_delete" onclick="delete_task('`+title+`')"><i class="fas fa-trash"></i></button>
          <button class="btn btn_display" onclick="display_desc('`+title+`')"><i class="fas fa-info-circle"></i></button>
          </div>
          `;
        }
        else{
...
function displayTask() {
  ...
  number.innerHTML = `<span class="card">Tasks to be completed = <span class="num">${live}</span></span><span class="card"> Completed Tasks = <span class="num">${com}</span></span>`;
  display.innerHTML = "";
